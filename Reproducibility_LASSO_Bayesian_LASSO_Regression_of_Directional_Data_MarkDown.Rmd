---
title: "Reproduciblity LASSO and Bayesian LASSO Regression for Directional Response (d=2)"
output:
...
plt_vio<-plot_beta_p_20_d_2(Mc_obj, PlotType = 'vio', zero_marking_linetype=6, zero_marking_linewidth=.5)
plt_vio
plt_box<-plot_beta_p_20_d_2(Mc_obj, PlotType = 'box', zero_marking_linetype=6, zero_marking_linewidth=.5)
plt_box
...
```{r }
library(glmnet)
n=200    # Number of the samples
p=20      # Number of the regression covariates
d=2     # Number of directions in the directional data

#Test Lasso
data_lst  <-  Data_generator_vnf_reg_sparse(n=n, p=p, d=d,SetUp = 2, NumOfNonZeroBeta=c(3, 2, 10))

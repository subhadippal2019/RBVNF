---
title: 'Reproduciblty Report: R MarkDown for  Real Data Analysis'
output:
...
```{r }
  lst_germany=MCMC_Dir_regression_sampler_V1(Y=Y, X=X, prior=NULL, beta_init = NULL,  MCSamplerSize =11000)
